...
public abstract class StreamingSerialPortDeviceController<T, U>
   ...
   public static final String USE_FAKE_DEVICES_SYSTEM_PROPERTY_KEY = "org.chargecar.serial.streaming.StreamingSerialPortDeviceController.use-fake-devices";

   protected static boolean shouldUseFakeDevice()
      {
      return Boolean.valueOf(System.getProperty(USE_FAKE_DEVICES_SYSTEM_PROPERTY_KEY, "false"));
      }
   ...
   private final StreamingSerialPortDeviceController.ConnectionCreator connectionCreator = new ConnectionCreator();
