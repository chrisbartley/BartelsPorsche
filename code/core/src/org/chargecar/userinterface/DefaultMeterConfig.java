...
public class DefaultMeterConfig implements MeterConfig
   ...
   private Color backgroundColor = UserInterfaceConstants.DEFAULT_METER_COLOR;
   private Color backgroundWarningColor = UserInterfaceConstants.METER_WARNING_COLOR;
