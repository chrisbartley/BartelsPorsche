...
public class Meter extends JPanel
   ...
   public Meter(final MeterConfig meterConfig, final double initialValue)
      ...
      //if (meterConfig.getLabel() != null)
      //   {
      //   final DialTextAnnotation annotation1 = new DialTextAnnotation(meterConfig.getLabel());
      //   annotation1.setFont(new Font("Dialog", Font.BOLD, 13));
      ...
      if (meterConfig.getLabel() != null)
         {
         final DialTextAnnotation annotation2 = new DialTextAnnotation(meterConfig.getLabel());
         annotation2.setFont(new Font("Dialog", Font.BOLD, 14));
      ...
      dialValueIndicator.setFont(new Font("Dialog", Font.BOLD, 16));
